      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-2xl font-bold text-primary">ShopVibe</span>
          </Link>
          <h1 className="text-2xl font-bold text-primary">Create an account</h1>
          <p className="text-muted mt-1">Join ShopVibe for the best shopping experience</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-accent transition-colors pr-10"
                  placeholder="••••••••"
            ...
            <button
              type="submit"
              className="w-full py-3 bg-accent hover:bg-accent-hover text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-accent/25"
            >
              Create Account
            </button>
          </form>
